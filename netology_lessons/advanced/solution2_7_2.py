"""
LESSON 2.7, EX. 3
Refactored from: https://github.com/netology-code/py-homework-advanced/blob/master/2.7.Interview/PEP8.md
"""
...
if __name__ == '__main__':
    email_manager = NEmail(GMAIL_SMTP, GMAIL_IMAP, 'login@gmail.com', 'password')
    email_manager.send('Subject', ['vasya@rambler.ru'], 'Message')
